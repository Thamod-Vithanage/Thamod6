<h1 align="center">Hi 👋, I'm Thamod Vithanage</h1>
...
<p>
  ...
  <img src="https://img.shields.io/badge/SmarterASP.NET-2E3A59?style=flat-square" />
</p>
...
**[YalaGuard – Real-Time Elephant Tracking & Drone Surveillance System](https://github.com/Thamod6/YalaGuard-Real-Time-Elephant-Tracking-and-Drone-Surveillance-System)**
Web-based wildlife monitoring platform for Yala National Park with real-time GPS tracking, geofencing, and automated alerts. `PHP` `MongoDB Atlas` `Google Maps API` `PHPMailer`

**[Banana Catcher – Interactive Web-Based Game](https://github.com/Thamod6/banana-catcher2)**
Browser-based game with dynamically generated math challenges, user accounts, and leaderboard tracking via a PHP/MySQL backend. `PHP` `MySQL` `REST API` `JavaScript`

**[ThisaraTravels – Vehicle Rental Web Application](https://github.com/IsuruG99/ThisaraTravels)**
Led a 5-member team building a full vehicle rental platform with secure auth, booking, and admin management. `HTML` `CSS` `JavaScript` `PHP` `MongoDB`
...
<p align="center"><i>Thanks for stopping by — always open to connecting on new projects and opportunities!</i></p>
